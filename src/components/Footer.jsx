            ...
            <div className="flex space-x-4">
             ...
             <div className="mt-6">
                ...
                <form className="flex" onSubmit={handleSubscribeSubmit}>
                    ...
                    <button
                        type="submit"
                        className="px-4 py-2 bg-purple-600 text-white text-sm font-medium rounded-r-md hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 transition-colors duration-200"
                    >
                        Subscribe
                    </button>
                </form>
